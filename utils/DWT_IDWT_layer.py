...
class DWT_2D(Module):
    ...
    def __init__(self, wavename):
        ...
        wavelet = pywt.Wavelet(wavename)
        self.band_low = wavelet.rec_lo #1/\sqrt{2}[1,1]
        self.band_high = wavelet.rec_hi #1/\sqrt{2}[1,-1]
        assert len(self.band_low) == len(self.band_high)
        self.band_length = len(self.band_low) #2
        assert self.band_length % 2 == 0
        self.band_length_half = math.floor(self.band_length / 2) #1
...
class IDWT_2D(Module):
    ...
    def __init__(self, wavename):
        ...
        wavelet = pywt.Wavelet(wavename)
        self.band_low = wavelet.dec_lo
        self.band_low.reverse() #1/\sqrt{2}[1,1]
        self.band_high = wavelet.dec_hi
        self.band_high.reverse() #1/\sqrt{2}[1,-1]
        assert len(self.band_low) == len(self.band_high)
        self.band_length = len(self.band_low)
        assert self.band_length % 2 == 0
        self.band_length_half = math.floor(self.band_length / 2)
